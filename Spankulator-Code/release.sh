...
cp ./out/Spankulator.ino.bin updater
cp ./out/Spankulator.ino.elf updater
cp Blink.ino.elf.uf2 updater
echo $release_num > updater/release.txt

# Create a zip file using the zip command
zip -r ./releases/spankulator_updater_$release_num.zip updater -x updater.sh
...
mv ./archive.tar.gz ./releases/spankulator_updater_$release_num.tar.zip
